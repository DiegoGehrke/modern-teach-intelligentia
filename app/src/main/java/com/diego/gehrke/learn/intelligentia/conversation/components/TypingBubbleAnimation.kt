package com.diego.gehrke.learn.intelligentia.conversation.components
...
fun TypingBubbleAnimation(modifier: Modifier = Modifier) {
    ...
    Row(modifier.fillMaxWidth(0.8f)) {
        repeat(3) { index ->
            ...
            val height by animateDpAsState(baseDiameter * heightPct, label = "")
            val width by animateDpAsState(baseDiameter * widthPct, label = "")
